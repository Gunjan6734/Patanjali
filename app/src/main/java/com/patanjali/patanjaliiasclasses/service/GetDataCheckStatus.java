...
public class GetDataCheckStatus extends AsyncTask<Object, Void, Object> {
   ...
   // public ProgressDialog dialog;
    ...
    public GetDataCheckStatus(Context context, JSONObject jsonObject, String url, OnTaskCompleted<String> listener, boolean isDialog)
    {
        this.url=url;
