...
public class PostData extends AsyncTask<Object, Void, Object> {
    ...
    public PostData(Context context, JSONObject jsonObject, String url, OnTaskCompleted<String> listener, boolean isDialog)
    {
        this.url=url;
