...
public class GetLiveData extends AsyncTask<Object, Void, Object> {
    ...
    public GetLiveData(Context context, JSONObject jsonObject, String url, OnTaskCompleted<String> listener)
    {
        this.url=url;
        ...
        if(sharedPreferences!=null)
        {
            ...
            Log.d("djsnkjdnsjk",""+SaveSharedPreference.getUserId()+" "+sharedPreferences);
        }
    }
    ...
    protected Object doInBackground(Object... objects) {
        ...
        try {
            ...
            Log.d("livesatutascode", String.valueOf(status_code));//
            Log.d("liveresponsecode", httpResponse.getEntity().getContent().toString());
