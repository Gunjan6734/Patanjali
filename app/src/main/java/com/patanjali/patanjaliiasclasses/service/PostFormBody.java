...
public class PostFormBody extends AsyncTask<Object, Void, Object> {
    ...
    MultipartEntityBuilder jsonObject;
    public String response="";
    int status_code = 0;

    boolean isDialog;

    public PostFormBody(Context context, MultipartEntityBuilder jsonObject, String url, OnTaskCompleted<String> listener, boolean isDialog)
    {
        this.url=url;
    ...
    @Override
    protected Object doInBackground(Object... objects) {//yaha copy kar diy hai
        try {
          ...
          //  se = new StringEntity(jsonObject.toString());
            HttpEntity entity = jsonObject.build();
