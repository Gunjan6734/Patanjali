...
public class PersentationActivity extends AppCompatActivity {

    private WebView webView;
    private FrameLayout framelayout2;
    final Activity activity = this;
    String persentationurl = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_persentation);
        ...
        persentationurl = getIntent().getStringExtra("persentationurl");
        // Toast.makeText(getApplicationContext(), "" + persentationurl, Toast.LENGTH_SHORT).show();
        ...
        if (ContextCompat.checkSelfPermission(PersentationActivity.this, Manifest.permission.CAMERA)
                            ...
                            public void onTaskCompleted(String response) {
                                ...
                                try {
                                    ...
                                    if (responseCode.equals("1")){
                                        ...
                                        Intent intent=new Intent(PersentationActivity.this,MainActivity.class);
                                        startActivity(intent);
                                        PersentationActivity.this.finish();
                                        PersentationActivity.this.finishAffinity();
    ...
    private void loadWebSite() {
        webView.loadUrl(persentationurl);
